...
var MenuCoolRgbaColorPickerOptions = {
	...
	rgbaColorPicker = function (E) {
		...
		var e = function (a, c, b) {
			...
			v = function (c) {
				for (var b = c.split(","), a = 0; a < b[d]; a++)
					if (+b[a] < 0 || +b[a] > 255) return 0;
				return 1
			},
		...
		B.prototype = {
			...
			d: function () {
				...
				a.j();
				a.o();
				e(document.documentElement, j, function () {
					a.r[b][h] = "none"
				});
				e(d, j, u)
			},
			...
			o: function () {
				for (var k = document.getElementsByTagName("input"), a = this, i = 0; i < k[d]; i++)
					if (D(k[i][m])) {
						var c = a.R[d];
						a.R[c] = k[i];
						a.R[c].i = c;
